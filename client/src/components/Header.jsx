...
const Header = () => {
  ...
  return (
    ...
    <Link to={'/'}  className="flex gap-1 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8n -rotate-90">
    ...
    <div className="flex border gap-2 border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
        ...
        <button className="bg-primary text-white p-2 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4e">
